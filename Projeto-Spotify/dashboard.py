...
with tab_dashboard:
    ...
    graph3.update_yaxes(title_text="Músicas Ouvidas", title_font_size=18)
    graph3.update_xaxes(title_text="",  title_font_size=18)
    ...
    df["turno"] = np.select(condlist=criterios, choicelist=turnos, default="")
